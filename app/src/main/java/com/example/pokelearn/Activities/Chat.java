...
import com.example.pokelearn.Adapters.MessageAdapter;
import com.example.pokelearn.GetTimeAgo;
            ...
            Task<Uri> urlTask = filepath.putFile(imageUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    if(task.isSuccessful()){
                        ...
                        String download_url = task.getResult().toString().trim();
...
//       ////  TEST /////
//        DatabaseReference mCount = mRootRef.child("messages").child(mCurrentUserId).child(mChatUser);
//
//        mCount.orderByKey().addValueEventListener(new ValueEventListener() {
//            @Override
//            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
//                cCount = dataSnapshot.getChildrenCount();
////                cCount = count.intValue();
//                Log.e("COUNT: ", cCount.toString());
//            }
//
//            @Override
...
//                    Log.e("LIST length: ", String.valueOf(messagesList.size()));
                }
                else {
                    mPrevKey = mLastKey;
                }
